...
//cod.
//Parcial: la operación no está definida si en el mercado m no existe un par (cod,e)
//(EmpresaInexistente), o si en m existe un par (cod,e) pero sesiónAbierta(e) es cierto
//(SesiónYaAbierta)
...
//cod.
//Parcial: la operación no está definida si en el mercado m no existe un par (cod,e)
//(EmpresaInexistente), o si en m existe un par (cod, e) pero sesiónAbierta(e) es
//Falso (SesiónYaCerrada)
...
//Si en el mercado m no existe un par (cod,e) devolverá la cadena vacía. Si en el mercado m
//existe un par (cod,e), devuelve una cadena que contiene consecutivamente las siguientes
//cadenas:
...
//el mercado m,
//- seguida de una línea con la cadena “-----“, y a continuación:
//- con la misma información y formato que el descrito para la operación listarEmpresa, se
//incluirá los datos de todas y cada una de las empresas del mercado m, en orden alfabético de
